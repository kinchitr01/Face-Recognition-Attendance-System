...
class Face_Recognition_System:
    ...
    def __init__(self,root):
       ...
       # bg_img=Label(self.root,image=self.photoimg2)
        ...
        b1=Button(self.root,image=self.photoimg3,command=self.face_recognize,cursor="hand2")
        b1.place(x=250,y=250,width=220,height=220)

        b1_l=Button(self.root,text="For Attendance Press P after Detection",command=self.face_recognize,cursor="hand2",font=("times new roman",15,"bold"), bg="dark blue",fg="white")
        b1_l.place(x=200,y=470,width=350,height=40)

        #Admin login button
        img4=Image.open(r"D:\D\Face Recognition Attendence System\Images\admin_login.jpg")
        img4=img4.resize((400,220),Image.LANCZOS)
        self.photoimg4=ImageTk.PhotoImage(img4)

        b2=Button(self.root,image=self.photoimg4,command=self.login_page,cursor="hand2")
        b2.place(x=900,y=250,width=400,height=220)

        b2_l=Button(self.root,text="For Admin click here",command=self.login_page,cursor="hand2",font=("times new roman",15,"bold"), bg="dark blue",fg="white")
        b2_l.place(x=900,y=470,width=400,height=40)

         #Exit Button
        img5=Image.open(r"D:\D\Face Recognition Attendence System\Images\Exit.png")
        img5=img5.resize((220,220),Image.LANCZOS)
        self.photoimg5=ImageTk.PhotoImage(img5)

        b3=Button(self.root,image=self.photoimg5,command=self.iExit,cursor="hand2")
        b3.place(x=600,y=500,width=220,height=220)

        b3_l=Button(self.root,text="For Exit click here",command=self.iExit,cursor="hand2",font=("times new roman",15,"bold"), bg="dark blue",fg="white")
        b3_l.place(x=600,y=700,width=220,height=40)
    ...
    def iExit(self):
        self.iExit=tk.messagebox.askyesno("Exit","Are you sure you want to exit??")
        if self.iExit >0:
            self.root.destroy()
        else:
            return
